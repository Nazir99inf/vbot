var handler = async (m, { conn }) => {
  var teks = `Kebijakan dan Privasi, Syarat, Ketentuan dan Peraturan

*Kebijakan & Privasi ( Pripacy And Poicy )*
...
handler.help = ["rules", "aturan", "rule"].map(
  (a) => a + " *[Info rules bot]*",
);
handler.tags = ["info"];
handler.command = ["rules", "aturan", "rule"];
